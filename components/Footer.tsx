      ...
      <div className="container-section py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <div className="w-12 h-12 bg-crimson-500 rounded-full flex items-center justify-center font-heading font-black text-white transition-transform group-hover:scale-110">
                JL
              </div>
              <div>
                <span className="block font-heading text-base font-black text-white">
                  JESUS LOVES YOU
                </span>
                <span className="block font-heading text-xs font-bold text-crimson-400 tracking-widest uppercase">
                  CITY CHURCH
                </span>
              </div>
            </a>
