...
const FALLBACK_EMBED = "https://www.youtube.com/embed?listType=user_uploads&list=jlymicentral233";
...
export default function Services() {
  const [embedUrl, setEmbedUrl] = useState(FALLBACK_EMBED);
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-start">
          ...
          <ScrollReveal direction="left" distance={50} blur>
            ...
            <div className="mt-4 flex gap-3">
              <a href="https://www.youtube.com/@jlymicentral233/streams" target="_blank" rel="noopener noreferrer" className="btn-primary flex-1 justify-center text-sm">
                Watch Live Streams
              </a>
          ...
          {/* Schedule — right, staggered */}
          <ScrollReveal direction="right" distance={50} blur>
