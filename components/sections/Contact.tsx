...
const contactInfo = [
  {
    icon: MapPin,
    label: "Address",
    value: "40 Mayon St, Mandaluyong City",
  ...
  },
  {
    icon: Mail,
    label: "Email",
    value: "jlymi.central@gmail.com",
    sub: "We respond within 24 hours",
    href: "mailto:jlymi.central@gmail.com",
  },
  {
    icon: Clock,
    label: "Office Hours",
      ...
      <div className="container-section" ref={ref}>
        ...
        >
          ...
          <p className="text-white/60 text-lg mt-5 max-w-2xl mx-auto">
            We'd love to meet you. Come as you are. Leave transformed. Reach out to us
            today and take your next step.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          >
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  {href ? (
                    <a
                      href={href}
                      className="text-white font-semibold hover:text-crimson-400 transition-colors block"
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <a href="tel:770005669" className="btn-primary flex-1 justify-center text-sm" aria-label="Call the church">
                Call Us Now <ChevronRight size={15} />
              </a>
              <a href="mailto:jlymi.central@gmail.com" className="btn-outline flex-1 justify-center text-sm" aria-label="Email the church">
